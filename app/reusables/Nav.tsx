...
import lightLogo from "../public/logowhite.svg";
import darkLogo from "../public/logoblack.svg"; // Replace these paths with the actual paths to your logo images

export function Nav({ darkMode }) {
